...
<body>
   <iframe title="frame1" srcdoc="<div style='margin-top:100px;text-align:center'><img src='./resources/images/favicon.png' height=100px><p>please wait a few moments...</p></div>" src='modules/home.php' onload="{this.removeAttribute('srcdoc'); window.document.title = this.contentDocument.title}">
   </iframe>
</body>
