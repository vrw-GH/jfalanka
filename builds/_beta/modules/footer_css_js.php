...
<!-- Match Height -->
<script type="text/javascript" src="<?php echo $thisRoot; ?>/resources/jquery-match-height-master/jquery.matchHeight.js"></script>
<script>
   $(function() {
      $(function() {
...
<!-- Custom Select -->
<link rel="stylesheet" href="<?php echo $thisRoot ?>/<?php echo $website['bootstrap_folder']; ?>/custom_select/dist/css/bootstrap-select.min.css">
<script src="<?php echo $thisRoot ?>/<?php echo $website['bootstrap_folder']; ?>/custom_select/dist/js/bootstrap-select.min.js" type="text/javascript" charset="utf-8"></script>
