<?php
$pageinfo = json_decode($_GET['pageinfo']);
               ...
               <div class="row">
                  <div class="container voffset-2">
                     <div class="row animatedParent">
                        ...
                        <a href="<?= WEB_HOST ?>">
                           <img src="resources/images/logo-jfa.png" class="comp-logo img-responsive img-center animated fadeInUpShort" alt="<?= $website['abbrev'] ?>_logo" />
                        </a>
                                 ...
                                 <div class="col-xs-12">
                                    <div class="row">
                                       ...
                                       <div class="front-items sp animated pulse slow hvr-overline-from-center" data-id='<?php echo $data_id; ?>'>
                                          <div class="icon-wrap">
                                             <a href="<?php echo (defined(LOCAL)) ? SITES[$row['cat_order']] : $row['custom_url']; ?>">
                                                <img src="<?php echo ($row['upload_path'] != null) ? 'uploads/' . $row['upload_path'] : $row['cat_logo']; ?>" class="img-responsive" alt="<?php echo $row['cat_url_slug']; ?>">
                                             </a>
                     ...
                     <div class="col-xs-12 voffset-b-2 front-jumbo-box">
                        ...
                        <div class="col-xs-12 col-sm-6">
                           <div class="col-xs-12 voffset-2 front-welcome animated fadeInLeftShort xx(hvr-underline-from-center)">
                              ...
                              <img src="<?= $website['logo']; ?>" class="comp-logo img-responsive img-center" alt="<?= $website['abbrev'] ?>" />
