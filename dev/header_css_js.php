...
<link rel="shortcut icon" type="image/png" href="<?php echo $thisRoot ?>./resources/images/favicon.png" />
...
<link rel="stylesheet" type="text/css"
   href="<?php echo $thisRoot ?>/<?php echo $website['boostrap_folder']; ?>/css/bootstrap.min.css" media="all" />
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo $thisRoot ?>/resources/css/style.css" media="all" />

<!-- Error css -->
<link rel="stylesheet" href="<?php echo $thisRoot ?>/resources/css/Errors/validationEngine.jquery.css"
   type="text/css" />
...
<script type="text/javascript" src="<?php echo $thisRoot ?>/<?php echo $website['jquery_migrate_js']; ?>"
   charset="utf-8">
</script>
<script type="text/javascript" src="<?php echo $thisRoot ?>/<?php echo $website['jquery_migrate_lower_js']; ?>"
   charset="utf-8">
</script>
...
<script type="text/javascript"
   src="<?php echo $thisRoot ?>/<?php echo $website['boostrap_folder']; ?>/js/bootstrap.min.js" charset="utf-8">
</script>
...
<!-- Error Js -->
<script src="<?php echo $thisRoot ?>/resources/js/Languages/jquery.validationEngine-en.js" type="text/javascript"
   charset="utf-8">
</script>
...
<!-- Pagination Default -->
<link href="<?php echo $thisRoot ?>/resources/pagination_static/css/pagination.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $thisRoot ?>/resources/pagination_static/css/grey.css" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" type="text/css" href="<?php echo $thisRoot ?>/resources/fancybox/source/jquery.fancybox.css"
   media="screen" />

<!-- Add Button helper (this is optional) -->
<link rel="stylesheet" type="text/css"
   href="<?php echo $thisRoot ?>/resources/fancybox/source/helpers/jquery.fancybox-buttons.css" />
<script type="text/javascript"
   src="<?php echo $thisRoot ?>/resources/fancybox/source/helpers/jquery.fancybox-buttons.js"></script>

<!-- Body Items Animation CSS -->
<link rel="stylesheet" href="<?php echo $thisRoot ?>/resources/css3-animate-it-master/css/animations.css"
   type="text/css">

<!--[if lte IE 9]>
      <link href='<?php echo $thisRoot ?>/resources/css3-animate-it-master/css/animations-ie-fix.css' rel='stylesheet'>
<![endif]-->

<!-- hover effects -->
<link href="<?php echo $thisRoot ?>/resources/hover-master/css/hover-min.css" rel="stylesheet" media="all">
