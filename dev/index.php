                                            ...
                                            <div class="col-xs-12 col-pdn-both-0 voffset-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        ...
                                                        <h5 class="text-bold voffset-1"><?= SITE1[1] ?>
                                                        </h5>
                                                        <a href="<?= SITE1[0] ?>" class="voffset-1">www.tropicalhomes.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        ...
                                                        <h5 class="text-bold voffset-1"><?= SITE2[1] ?>
                                                        </h5>
                                                        <a href="<?= SITE2[0] ?>" class="voffset-1">www.sunbird.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        ...
                                                        <h5 class="text-bold voffset-1"><?= SITE3[1] ?>
                                                        </h5>
                                                        <a href="<?= SITE3[0] ?>" class="voffset-1">www.sensepv.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
