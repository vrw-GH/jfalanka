...
<link rel="stylesheet" href="<?php echo $thisRoot ?>/resources/bootstrap-3.3.7/css/bootstrap.min.css" type="text/css"
   media="all">
...
<script type="text/javascript"
   src="<?php echo $thisRoot ?>/<?php echo $website['bootstrap_folder']; ?>/js/bootstrap.min.js" charset="utf-8">
</script>
