        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 voffset-1">
                    ...
                    <div id="outer-box">
                        <div id="mm">
                            <h1>Add Category Gallery Images</h1>
                            <!-- forms END -->
                            <div class="col-xs-12 voffset-b-3">
                                <form id="my-awesome-dropzone" action="dropzoneupload.php" class="dropzone">
                                    ...
                                    <input type="hidden" name="cat_code" value="<?php echo $cat_code; ?>"/>
                                    <input type="hidden" name="key" value="<?php echo $_SESSION['key']; ?>"/>
                                    <div class="fallback">
                                        <input name="cat_img" type="file" multiple />
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-xs-12 col-pdn-both-0 voffset-1">
                            <a href="item_main_category_gallery.php?cat_code=<?php echo $cat_code; ?>" class="btn btn-info float-right" id="refresh">View uploaded files</a>
                        </div>
                        <?php
                        $myCon = new dbConfig();
                        $myCon->connect();
                        $query = "SELECT c.cat_code, c.cat_name, u.upload_id, u.upload_path FROM upload_data u "
                                . "LEFT JOIN item_main_category c ON u.upload_ref = c.cat_code WHERE "
                                . "u.upload_type_id='2' AND u.featured != 1 AND u.upload_ref = '" . $cat_code . "' "
                    ...
                    <script>
                        Dropzone.options.myAwesomeDropzone = {
                            ...
                            paramName: "cat_img", /* Defaults is file and no need to put here */
