        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 voffset-1">
                    ...
                    <div id="outer-box">
                        <div id="mm">
                            <h1>Add News & Events Gallery Images</h1>
                            <!-- forms END -->
                            <div class="col-xs-12 voffset-b-3">
                                <form id="my-awesome-dropzone" action="dropzoneupload.php" class="dropzone">
                                    ...
                                    <div class="fallback">
                                        <input name="ann_img" type="file" multiple />
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-xs-12 col-pdn-both-0 voffset-1">
                            <a href="news_gallery.php?ann_id=<?php echo $ann_id; ?>" class="btn btn-info float-right" id="refresh">Reload uploaded files</a>
                        </div>
                        <?php
                        $myCon = new dbConfig();
                        $myCon->connect();
                        $query = "SELECT n.ann_title, u.* FROM upload_data u LEFT JOIN news_events n ON "
                                . "u.upload_ref = n.ann_id WHERE u.upload_type_id=10 AND "
                                . "u.upload_ref='" . $ann_id . "' AND u.featured!= 1 ORDER BY u.upload_type_id DESC";
                        $result = $myCon->query($query);
                        ?>
                        <h1>Category Gallery Images</h1>
                                    ...
                                    <div class="col-xs-6 col-sm-3 col-lg-2 grid-item">
                                        <div id="imgbox-outer">
                                            <form id="formID<?php echo $form_id ?>" method="post" action="" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="ann_id" value="<?php echo $ann_id; ?>">
                                                <img src="../uploads/<?php echo($row['upload_path']) ?>" alt="" class="img-responsive img-thumbnail" style="max-width: 150px;"/>
                    ...
                    <script>
                        Dropzone.options.myAwesomeDropzone = {
                            ...
                            paramName: "ann_img", /* Defaults is file and no need to put here */
