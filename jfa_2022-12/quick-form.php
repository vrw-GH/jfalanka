            ...
            <div class="modal-dialog">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title" id="contactLabel"><span class="glyphicons glyphicons-message-plus"></span>&nbsp; If you would like more information? Feel free to contact us.</h4>
                    </div>
                    <div class="row">
                            ...
                            <div class="container-fluid">
                                ...
                                if (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['quick-form']) &&
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                        if (trim($_POST['firstname']) == null || trim($_POST['lastname']) == null ||
...
<script>
    $(document).ready(function () {
        ...
        $(".data_rent").click(function () {
            ...
            $('#contact-rentals').modal({modal: true, backdrop: 'static', keyboard: false});
        });
