 ...
 */
define('WEB_HOST', 'http://www.jfalanka.com');
...
/*
 * -----------------------------------------------------------------------------
 * normal variables cannot be accessed inside a function hence creating global variables
 */
define('SEND_EMAIL', 'noreply@jfalanka.com'); /* use accountname@host.phenomhost.com */
define('REC_EMAIL', $website['email']);
