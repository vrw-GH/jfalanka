                        ...
                        <div class="row">
                            <div class="container  voffset-2">
                                <div class="row animatedParent">
                                    ...
                                    <a href="http://www.jfalanka.com">
                                        <img src="resources/images/logo.png" class="img-responsive img-center animated fadeInUpShort" alt="JFA"/>
                                    </a>
                                    <h1 class="voffset-1 voffset-b-2 text-center text-uppercase text-bold animated fadeInDownShort">Welcome to Jude Fernandopulle Associates (Pvt) Ltd.</h1>
<img src="resources/images/30yrAnniv5.png" class="img-responsive img-center animated fadeInUpShort" alt="JFA"/>
                                </div>
                                <div class="row animatedParent animateOnce" data-sequence='500'>
                                    <hr class="style-four"/>
                                    <div class="col-xs-12 voffset-3 visible-xs visible-sm"></div>
                                    <h3 class="voffset-1 voffset-b-3 text-center text-uppercase text-bold">Products & Service Section</h3>
                                    <?php
                                    $myCon = new dbConfig();
                                    $myCon->connect();
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="col-xs-6 col-sm-4 <?php echo $colum; ?> col-xxs-full-width voffset-b-5">
                                            <div class="container-fluid col-xs-pdn-both-0">
                                                <div class="col-xs-12">
                                                    <div class="row">
                                                        <div class="front-items sp animated pulse slow hvr-underline-from-center" data-id='<?php echo $data_id; ?>'>
                                                            <div class="icon-wrap">
                                                                <a href="<?php echo $row['custom_url']; ?>"><img src="uploads/<?php echo $row['upload_path']; ?>" class="img-responsive" alt="<?php echo $row['cat_url_slug']; ?>"></a>
                                                            </div>
                                ...
                                <div class="col-xs-12 voffset-b-2 front-jumbo-box">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="col-xs-12 voffset-2 front-welcome animated fadeInLeftShort hvr-underline-from-center">
                                            ...
                                            <p class="voffset-1">
                                                Incorporated in the Democratic Socialist Republic of Sri Lanka under theCompanies Act No.17 of 1982. Registration No: N(PVS)9832 dated 25-Sep-1992 ICTAD (M5) Registration No 5730. Member of the NCCASL.
                                                <br/>
                                                Founded in 1989, JFA had very humble beginnings and has grown and prospered with much hard work, and today still holds on to its core values of providing the Best Service with Quality and maintaining our best asset – our very loyal customer base.
                                            </p>
                                            <h3 class="text-uppercase text-bold voffset-8">Our Vision</h3>
                                            <p class="voffset-1">To be the forerunner in Solar Technology and set standards in eco friendly environments
                                                Preserving human values in harmony with technology
                                            </p>
                                            <h3 class="text-uppercase text-bold voffset-8">Our Mission</h3>
                                            <p class="voffset-1">To make JFA synonymous with "Quality and Service", and SUNBIRD a household word as the “Best provider of Solar Technology” at affordable cost and of international standards with highest level of after-sales service.</p>
                                        </div>
                                        <div class="col-xs-12 voffset-4 text-center col-pdn-both-0">
                                            <a href="javascript:void(0);" class="data_rent btn btn-primary hvr-underline-from-center voffset-3 square" data-id="JFA Products and Services"><span class="glyphicons glyphicons-message-plus"></span>&nbsp; Contact us for all your Solar needs</a>
                                        </div>
                                        <?php
                                    ...
                                    <div class="col-xs-12 col-sm-6 animated fadeInRightShort">
                                        <div class="col-xs-12 col-xxs-pdn-both-0 voffset-b-4">
                                            ...
                                            <a href="http://www.jfalanka.com">
                                                <img src="resources/images/logo.png" class="img-responsive img-center" alt="JFA"/>
                                            </a>
                                            ...
                                            <div class="col-xs-12 col-pdn-both-0 voffset-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-5 col-xxs-full-width">
                                                        <a href="http://www.tropicalhomes.lk">
                                                            <img src="resources/images/tropicalhomes-logo.jpg" class="img-responsive img-center" alt="www.tropicalhomes.lk"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        ...
                                                        <h5 class="text-bold voffset-1">Tropical Homes
                                                        </h5>
                                                        <a href="http://www.tropicalhomes.lk" class="voffset-1">www.tropicalhomes.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
                                                <div class="row">
                                                    <div class="col-xs-5 col-xxs-full-width">
                                                        <a href="http://www.sunbird.lk">
                                                            <img src="resources/images/sunbird-logo.jpg" class="img-responsive img-center" alt="www.sunbird.lk"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        <div class="text-bold text-info">
                                                        ...
                                                        <h5 class="text-bold voffset-1">SUNBIRD Technology
                                                        </h5>
                                                        <a href="http://www.sunbird.lk" class="voffset-1">www.sunbird.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
                                                <div class="row">
                                                    <div class="col-xs-5 col-xxs-full-width">
                                                        <a href="http://www.sunbird.lk/sense-pv-solar-energy-systems">
                                                            <img src="resources/images/sense-logo.png" class="img-responsive img-center" alt="www.sensepv.lk"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-7 col-xxs-full-width col-xxs-text-center">
                                                        <div class="text-bold text-info">
                                                        ...
                                                        <h5 class="text-bold voffset-1">SENSE
                                                        </h5>
                                                        <a href="http://www.sunbird.lk/sense-pv-solar-energy-systems" class="voffset-1">www.sensepv.lk</a>
                                                    </div>
                                                </div>
                                                <hr class="style-four"/>
